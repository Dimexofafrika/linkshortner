...
async function shortenLink(){
    ...
    listItem.className = "bg-white w-full rounded-md flex flex-col py-4 md:h-16 md:flex-row md:items-center px-4 md:py-4"
    hr.className = "md:hidden"
    inputlink.className = "text-black font-semibold text-lg mb-2 md:text-lg md:font-semibold md:flex-1 md:mb-0 "
    link.className = "my-2 text-cyan-300 font-semibold text-lg md:font-semibold md:text-lg md:ml-auto"
